            ...
            defaultMiddlewares.push(function (request, response, next) {
                ...
                if (isPromiseLike_1.isPromiseLike(checkResult)) {
                    checkResult.then(function (result) {
                        if (!result) {
                            return _this.handleError(new AccessDeniedError_1.AccessDeniedError(action), actionMetadata, action);
                        }
                        else {
                            next();
                        }
                    ...
                    if (!checkResult) {
                        _this.handleError(new AccessDeniedError_1.AccessDeniedError(action), actionMetadata, action);
                    }
                    else {
                        next();
                    }
